...
//Code here
favoriteThings.car = `Porsche 9-11`;
...
console.log(totalPopulation(testObj2))
...
let ingredients = (obj) => {
 ...
 let newArrOfObjects = [];
 newArrOfObjects.push(carb, fat, protien);
 return newArrOfObjects
}
console.log(ingredients(tempProps))
